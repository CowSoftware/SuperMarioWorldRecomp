...
EXE_R = r'F:\Projects\snesrecomp\SuperMarioWorldRecomp\build\bin-x64-Release\smw.exe'
EXE_O = r'F:\Projects\snesrecomp\SuperMarioWorldRecomp\build\bin-x64-Oracle\smw.exe'
